...
2. As for as I know, UOG and GDOE want to give college credits to the High Schoolers that pass. They may have to give credits in order for this program to take place.
    ...
    We have [Justin](https://github.com/hallaathrad), the FCC Councelor in our [Gitter](https://gitter.im/Chovin/DocomoFreeCodeCamp). We have started a conversation with him on how to solve this and are waiting for an update.
